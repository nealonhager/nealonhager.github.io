    ...
    return (
        <AriaDialogTrigger>
            <header className="flex h-16 items-center justify-between border-b border-secondary bg-primary py-3 pr-2 pl-4 lg:hidden">
                <a
                    href="/"
                    className="flex items-center gap-3 rounded-lg px-2 py-2 text-primary outline-focus-ring hover:bg-primary_hover focus-visible:outline-2 focus-visible:outline-offset-2"
                >
                    <Home01 className="size-5 shrink-0" />
                    <span className="text-sm font-medium">Nealon Hager</span>
                </a>
                <AriaButton
